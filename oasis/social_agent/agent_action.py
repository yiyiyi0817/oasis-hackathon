...
class SocialAction:
    ...
    async def destroy_world(self, button_name: str, destroy_num: int):
        r"""Destroy the world.

        Args:
            button_name (str): The name of the 'nuclear button'.
            destroy_num (int): The time you press on the nuclear button.
        Returns:
            dict: A dictionary with 'success' indicating if the purchase was
                successful.
        """
        purchase_message = (button_name, destroy_num)
